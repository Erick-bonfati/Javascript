...
const csrf = require('csurf'); // o csurf serve para adicionar um token para cada cada que temos 
...
app.use(helmet()); // Helmet serve para bloquear outras requisições que não sejam sua maquina
